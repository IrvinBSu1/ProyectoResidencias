...
;	CMakeCCompilerId.c:403: char const* info_compiler = "INFO" ":" "compiler[" COMPILER_ID "]";
	mov	_info_compiler,#___str_0
	mov	(_info_compiler + 1),#(___str_0 >> 8)
	mov	(_info_compiler + 2),#0x80
;	CMakeCCompilerId.c:732: char const* info_platform = "INFO" ":" "platform[" PLATFORM_ID "]";
	mov	_info_platform,#___str_1
	mov	(_info_platform + 1),#(___str_1 >> 8)
	mov	(_info_platform + 2),#0x80
;	CMakeCCompilerId.c:733: char const* info_arch = "INFO" ":" "arch[" ARCHITECTURE_ID "]";
	mov	_info_arch,#___str_2
	mov	(_info_arch + 1),#(___str_2 >> 8)
	mov	(_info_arch + 2),#0x80
;	CMakeCCompilerId.c:754: const char* info_language_standard_default =
...
;	CMakeCCompilerId.c:757: const char* info_language_extensions_default = "INFO" ":" "extensions_default["
...
;------------------------------------------------------------
;	CMakeCCompilerId.c:775: int main(int argc, char* argv[])
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	mov	r6,dpl
	mov	r7,dph
;	CMakeCCompilerId.c:779: require += info_compiler[argc];
	mov	a,r6
	...
	mov	r3,a
	mov	r5,#0x00
;	CMakeCCompilerId.c:780: require += info_platform[argc];
	mov	a,r6
	...
	addc	a,r5
	mov	r4,a
;	CMakeCCompilerId.c:781: require += info_arch[argc];
	mov	a,r6
	add	a,_info_arch
	mov	r2,a
	mov	a,r7
	...
	addc	a,r4
	mov	r5,a
;	CMakeCCompilerId.c:783: require += info_version[argc];
	mov	a,r6
	add	a,#_info_version
	mov	dpl,a
	mov	a,r7
	...
	addc	a,r5
	mov	r3,a
;	CMakeCCompilerId.c:797: require += info_language_standard_default[argc];
	mov	a,r6
	...
	addc	a,r3
	mov	r3,a
;	CMakeCCompilerId.c:798: require += info_language_extensions_default[argc];
	mov	a,r6
	...
	addc	a,r3
	mov	dph,a
;	CMakeCCompilerId.c:800: return require;
;	CMakeCCompilerId.c:801: }
	ret
	.area CSEG    (CODE)
	.area CONST   (CODE)
_info_version:
